      ...
      <div className="container" data-aos="fade-up">
        <div className="row mt-5">
          ...
          <div className="col-lg-8 mt-5 mt-lg-0">
            ...
            <form name="submit-to-google-sheet" role="form" className="php-email-form">
              <div className="row">
                <div className="col-md-6 form-group">
                  <input type="text" name="nama" className="form-control" id="name" placeholder="Your Name" required />
                </div>
              </div>
              ...
              <div className="form-group mt-3">
                <textarea className="form-control" name="pesan" rows={8} placeholder="Message" required />
              </div>
              <div className="my-3">
